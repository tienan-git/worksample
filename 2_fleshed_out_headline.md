...
- Webアプリケーションを開発するには、必ずWebフレームワークを使う必要はありませんが、ウェブフレームワークは、一般的なウェブ**開発操作を簡素化する**ためのツールとライブラリーを提供しますので、使用することを強くお勧めします。

- それはあなたの**人生をずっと楽にする**でしょう。
...
Ruby on Railsの入門準備として、Webフレームワークの基本概念やRuby on Railsの基本概念と選択理由などを紹介しました。
